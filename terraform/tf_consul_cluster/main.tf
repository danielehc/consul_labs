...
resource "azurerm_resource_group" "main" {
  name     = "daniele-consul-single-region"
  location = "westus"
}
...
module "network_westus" {
  ...
  location              = "westus"
  network_name          = "daniele-consul-westus"
...
module "consul_azure_westus" {
  source                    = "../modules/consul-azure-2"
  resource_group_name       = "${azurerm_resource_group.main.name}"
  consul_datacenter         = "daniele-consul-westus"
  location                  = "westus"
...
module "consul_azure_westus_agents" {
  source                    = "../modules/consul-azure-2"
  resource_group_name       = "${azurerm_resource_group.main.name}"
  consul_datacenter         = "daniele-consul-westus"
  location                  = "westus"
